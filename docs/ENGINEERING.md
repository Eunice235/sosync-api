# SOSync — engineering notes

The [README](../README.md) says what SOSync does and how to try it. This is how it is built, what
it is tested against, and everything it does not do.
...
The app talks to whichever API address is set in `mobile/lib/config.dart`, which is the hosted
one by default; to run it against a backend on this machine, see
